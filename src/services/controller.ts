...
import { byteInformationUsedBytesContainsAddressNumber } from '@/services/dataServices/byteInformationService';
...
import ReverseDebugger from '@/services/reverseDebugger/reverseDebugger';
...
export default class StepController {
  ...
  private async increaseIp() {
    const nextInstructionPointer = calculateNextInstructionPointer(this.state);
